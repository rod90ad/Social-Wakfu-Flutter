...
class BattleSecondaryTile extends StatelessWidget {
  ...
  BattleSecondaryTile(this.imgIdx, this.stream, this.title, this.sulfix);
        ...
        Stack(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/btl_sec_$imgIdx.png"),
